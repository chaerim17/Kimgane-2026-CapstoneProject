...
| Paperlogy-1.001 | Font | [Freesentation Paperlogy Font](https://freesentation.blog/paperlogyfont) | SIL Open Font License (OFL) | 타이틀/설정 UI 텍스트 렌더링용 폰트 | No | ymid0610 | `Assets/Fonts/Paperlogy-1.001/`; TTF 9 weights, v1.001(2024-10-07). 글꼴 단독 판매 및 라이선스 변경 제외 사용 가능 |
